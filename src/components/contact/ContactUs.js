...
export default function ContactUs() {
  ...
  return (
    <>
      <main>
        <div className="max-w-screen-xl mt-12 mb-12 px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto bg-gray-100 text-gray-900 rounded-lg shadow-lg">
          ...
          >
            <div>
              <span className="uppercase text-sm text-green-dark font-bold">
                Full Name *
              </span>
              <input
                className="w-full mt-2 py-3 px-3 rounded-lg bg-green-light border border-green dark:border-green-dark text-green-dark font-semibold focus:border-green-dark focus:outline-none focus:bg-green-lightest"
                type="text"
            ...
            <div className="mt-8">
              <button className="uppercase text-sm font-bold tracking-wide bg-green text-green-dark  p-3 rounded-lg w-full focus:outline-none focus:shadow-outline hover:bg-green-dark hover:text-green-lightest transition ease-in-out duration-300">
                Send Message
              </button>
            </div>
          </form>
