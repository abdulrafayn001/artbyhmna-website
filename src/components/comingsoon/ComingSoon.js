            ...
            <div className="bg-white rounded-lg shadow-lg p-5 md:p-20 mx-2">
              <div className="text-center">
                <h2 className="text-4xl tracking-tight leading-10 font-extrabold text-gray-900 sm:text-5xl sm:leading-none md:text-6xl">
                  ArtBy<span className="text-indigo-600">Hmna</span>
                </h2>
                <h3 className='text-xl md:text-3xl mt-10'>Coming Soon</h3>
                <p className="text-md md:text-xl mt-10"><a className="hover:underline" href="https://www.instagram.com/artbyhmna">ArtByHmna</a> is a website help you provide handmade gifts for you love onces.</p>
              </div>
              <div className="flex flex-wrap mt-10 justify-center">
                <div className="m-3">
                  <a href="https://www.facebook.com/ArtByHmna/" title="Quicktoolz On Facebook"
                ...
                <div className="m-3">
                  <a href="https://twitter.com/artbyhmna" title="Quicktoolz On Twitter"
                ...
                <div className="m-3">
                  <a href="https://www.instagram.com/artbyhmna" title="Quicktoolz On Pinterest"
                ...
                <div className="m-3">
                  <a href="https://www.youtube.com/channel/UC29fBX8pHL5AmswR1_DLwRg" title="Quicktoolz On Facebook"
